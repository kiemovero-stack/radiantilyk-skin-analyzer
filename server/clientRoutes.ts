...
async function runClientAnalysisInBackground(
  ...
  try {
    ...
    imageContents.push({
      type: "text",
      text: `Analyze these ${imageUrls.length} skin photo(s) (angles: ${imageAngles.join(", ")}) for a client self-assessment.${concernsText}${multiAngleInstructions}\n\nCRITICAL INSTRUCTION: If the client listed specific concerns above, you MUST address EVERY SINGLE ONE in your conditions list. If they said "Jawline & Chin Definition" — you MUST evaluate their jawline and report findings. If they said "Sagging & Loss of Volume" — you MUST look for and report on volume loss and laxity. FAILURE TO ADDRESS CLIENT CONCERNS IS UNACCEPTABLE.\n\nSCORING REMINDER: Be STRICT and REALISTIC with the skin health score. Most adults score 60-70. A score above 80 is uncommon. A score above 90 is extremely rare. Do NOT inflate scores to be nice — accuracy builds trust.\n\nProvide a complete, easy-to-understand skin analysis. Remember: explain everything in simple language that anyone can understand. Be warm, encouraging, and thorough. Recommend at least 3 facials, 4-8 procedures (with treatment series stacking when appropriate), and 5-7 skincare products from the catalog. Pay special attention to Fitzpatrick skin type when recommending treatments — some treatments are not suitable for all skin types.`,
    });
